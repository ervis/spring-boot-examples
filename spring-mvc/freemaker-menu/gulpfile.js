...
const js = {
  fileLocation: 'src/main/resources/static/assets/app/js/app.js',
  file: 'main.js',
  input: 'src/js',
...
gulp.task(task.copyResources, () =>
  gulp.src([`${paths.resources}/**`]).pipe(gulp.dest(build.classpath))
);
